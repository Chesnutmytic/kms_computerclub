...
$konteksArr = $retrievalData['konteks_teks'] ?? [];
$referensiArr = $retrievalData['sumber_referensi'] ?? [];
...
PENTING: Jika Anda memberikan contoh kode program atau tag HTML, Anda WAJIB membungkusnya dengan markdown code blocks (```) atau inline code (`). Jangan pernah menulis tag HTML secara langsung tanpa backticks.
